...
\newglossaryentry{awall}
{
	type=notation,
	name={\ensuremath{A_w}},
	description={oscillation amplitude of spanwise wall velocity $W_w$}
}
...
\newglossaryentry{ufl}
{
	type=notation,
	name={\ensuremath{\mathbf{u'}}},
	description={fluctuating velocity vector with components $(u',v',w')$}
}
\newglossaryentry{phase}
{
	type=notation,
	name={\ensuremath{\phi}},
	description={phase along a wave}
}
